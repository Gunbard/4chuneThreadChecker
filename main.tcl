...
proc vTclWindow.top46 {base} {
    ...
    button $top.but47 \
        -pady 0 -text Test 
    vTcl:DefineAlias "$top.but47" "Button3" vTcl:WidgetProc "Toplevel3" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.lab47 \
    ...
    place $top.but49 \
        -in $top -x 120 -y 120 -width 74 -height 30 -anchor nw \
        -bordermode ignore 
    place $top.ent50 \
    ...
    place $top.but55 \
        ...
        -bordermode ignore 
    place $top.but47 \
        -in $top -x 20 -y 120 -width 38 -height 29 -anchor nw \
        -bordermode ignore 
