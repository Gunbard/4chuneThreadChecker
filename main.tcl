...
proc vTclWindow.top45 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 410x321+742+465; update
    wm maxsize $top 1916 1053
    ...
    labelframe $top.lab55 \
        -text Title -height 60 -width 220 
    ...
    place $site_3_0.lab56 \
        -in $site_3_0 -x 5 -y 15 -width 207 -height 39 -anchor nw \
        -bordermode ignore 
    ...
    place $top.lab55 \
        ...
        -bordermode ignore 
    place $top.lab58 \
        -in $top -x 185 -y 120 -width 55 -height 50 -anchor nw \
        -bordermode ignore 
    place $top.lab59 \
        -in $top -x 185 -y 170 -width 55 -height 50 -anchor nw \
        -bordermode ignore 
    place $top.lab60 \
